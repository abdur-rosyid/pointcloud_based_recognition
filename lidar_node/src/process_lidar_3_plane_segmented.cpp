...
public:
	...
	// Assign publisher
        this->publisher = this->nh.advertise<pcl::PCLPointCloud2> ("/velodyne_points_filtered", 1); 
        this->publisher_plane = this->nh.advertise<pcl::PointCloud<pcl::PointXYZ> > ("/velodyne_segmented_plane", 1); 
